...
function genSignalHash(signal) {
    if (!bytes.isHexString(signal, 32)) {
        signal = strings.formatBytes32String(signal);
    }
    return BigInt(solidity.keccak256(["bytes32"], [signal])) >> BigInt(8);
}

function generateProof(identity, groupOrMerkleProof, externalNullifier, signal, snarkArtifacts) {
    return __awaiter(this, void 0, void 0, function () {
        var commitment, merkleProof, index, _a, proof, publicSignals;
