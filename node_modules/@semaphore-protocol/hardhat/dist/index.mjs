...
task("deploy:semaphore", "Deploy a Semaphore contract")
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    poseidonABI = poseidon_gencontract.generateABI(2);
                    poseidonBytecode = poseidon_gencontract.createCode(2);
...
task("deploy:verifier", "Deploy a Verifier contract")
    .addParam("merkleTreeDepth", "Merkle tree depth", undefined, types.int)
    .addOptionalParam("logs", "Print the logs", true, types.boolean)
    .setAction(function (_a, _b) {
